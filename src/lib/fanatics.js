...
export function fanaticsUrl(league, teamName) {
  ...
  // Use Fanatics site search — reliably shows team-specific gear for any team
  // without depending on o-+t- taxonomy params that can go stale.
  const dest = `https://www.fanatics.com/search?query=${encodeURIComponent(teamName)}`
